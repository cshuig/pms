package com.jiezhu.pms.comm.nmybatis;
...
import com.jiezhu.pms.comm.mybatis.Dialect;
import com.jiezhu.pms.comm.mybatis.PostgresqlDialect;
import com.jiezhu.pms.comm.util.ReflectUtil;
...
public class PageInterceptor implements Interceptor {
    ...
    private String getPageSql(Page<?> page, String sql, Dialect dialect) {
        return dialect.getLimitString(sql,
                (page.getPageStart() - 1) * page.getPageLimit(),
                page.getPageLimit());
    }
